...
export function HexPattern({ className }: HexPatternProps) {
  return (
    <>
      <style>{`
        @keyframes hex-hue { 100% { filter: hue-rotate(360deg); } }
      `}</style>
      <div
        ...
        style={{
          ...
          ['--b2' as string]: '#1c1b18',
          ['--b3' as string]: '#0c0b0a',
          ['--b4' as string]: '#0c0b0ae0',
          ['--c1' as string]: '#ffffff',
          ['--ts' as string]: '50% / calc(var(--sz) * 17.5) calc(var(--sz) * 29.5)',
          background: `
